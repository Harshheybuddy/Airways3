...
const Section4 = () => {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-[4rem] lg:gap-[7rem]'>
        <div className='flex flex-col items-center lg:items-start gap-[2rem] lg:gap-[5rem] justify-center'>
