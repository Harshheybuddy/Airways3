...
const Slider = () => {
    const list = [
        ...
        },
        {
            id: 3,
            title: "Large Jets",
            models: [{id:1,name:"Falcon 2000",
                about:"The Falcon 2000 has a maximum range of 3512 miles.",
                image:"https://heybuddystorage.blob.core.windows.net/s3-migratedheybuddy/airways_Assets/largeJets/falcon.svg"}, 
                {id:2,name:"Embraer Legacy 600",
                    about:"The Embraer Legacy 600 offers three spacious living spaces where passengers can work, dine and sleep.",
                    image:"https://heybuddystorage.blob.core.windows.net/s3-migratedheybuddy/airways_Assets/largeJets/Embraer.svg"},{id:1,name:"Falcon 2000",
                        about:"The Falcon 2000 has a maximum range of 3512 miles.",
                        image:"https://heybuddystorage.blob.core.windows.net/s3-migratedheybuddy/airways_Assets/largeJets/falcon.svg"}, 
                        {id:2,name:"Embraer Legacy 600",
                            about:"The Embraer Legacy 600 offers three spacious living spaces where passengers can work, dine and sleep.",
                            image:"https://heybuddystorage.blob.core.windows.net/s3-migratedheybuddy/airways_Assets/largeJets/Embraer.svg"},{id:1,name:"Falcon 2000",
                                ...
                                {id:2,name:"Embraer Legacy 600",
                                    about:"The Embraer Legacy 600 offers three spacious living spaces where passengers can work, dine and sleep.",
                                    image:"https://heybuddystorage.blob.core.windows.net/s3-migratedheybuddy/airways_Assets/largeJets/Embraer.svg"},],
                ...
                list.map((item, index) => {
                    return <div key={item.id} className={styles.list}>
                        ...
                        >
                            ...
                            <div className={`flex items-center w-full justify-center gap-[2rem] items-center mt-[1rem]`}>
