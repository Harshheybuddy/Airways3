  ...
  return (
    <div className={`${styles.container} `}>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-[4rem] lg:gap-[7rem] w-[100%]'>
            ...
            <div className='flex flex-col gap-[2rem] lg:gap-[5rem] items-center lg:items-start'>
                <h4 className={`${styles.heading} text-center lg:text-left`}>Kaushambi Airways</h4>
                <p className={`${styles.para} text-center lg:text-left`}>{`At Kaushambi Airways, we pride ourselves on delivering unmatched performance in every aspect of our services. From the moment you step through our doors, you are met with a commitment to excellence that permeates every facet of our operation.\n\nOur state-of-the-art facilities are meticulously maintained to provide a seamless and luxurious experience, whether you’re preparing for a flight or arriving at your destination. We leverage cutting-edge technology and industry best practices to ensure that our operations are not only efficient but also exceed the highest standards of safety and reliability.`}</p>      
